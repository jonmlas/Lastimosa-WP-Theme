...
$options = array(
	...
	'tab_list' => array(
		...
		'options' => array(
			...
			'style'   => array(
				'type'    => 'select',
				'label'   => __('Box Style', 'lastimosa'),
				'choices' => array(
					'aligncenter' => __('Icon above title', 'lastimosa'),
					'alignleft' 	=> __('Icon in line with before title', 'lastimosa'),
					'alignright' 	=> __('Icon in line with after title', 'lastimosa'),
				)
			),
			'title'    => array(
				'type'  => 'text',
