...
function page_meta_box_markup($object)
{
	...
	<div class="block">
		<label for="hide-page-title">
			<?php $hide_page_title = get_post_meta($object->ID, 'hide-page-title', true);
			if($hide_page_title == '') { ?>
				<input name="hide-page-title" type="checkbox" value="true">
			<?php }
			elseif($hide_page_title == 'true') { ?>  
	...
	<div class="block">
		<label for="hide-footer-widgets">
			<?php $hide_footer_widgets = get_post_meta($object->ID, 'hide-footer-widgets', true);
			if($hide_footer_widgets == '') { ?>
				<input name="hide-footer-widgets" type="checkbox" value="true">
				<?php }
			elseif($hide_footer_widgets == 'true') { ?>  
