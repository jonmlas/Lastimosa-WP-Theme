	...
	function fw_theme_paging_nav( $wp_query = null ) {
		...
		if ( $links ) :
			...
			<nav class="navigation paging-navigation" role="navigation">
				<h4 class="screen-reader-text"><?php _e( 'Posts navigation', 'unyson' ); ?></h4>
 ...
 */ {
	function fw_theme_post_nav() {
		...
		<nav class="navigation post-navigation" role="navigation">
			<h3 class="screen-reader-text"><?php _e( 'Post navigation', 'unyson' ); ?></h3>
			...
			<div class="nav-links">
				...
				if ( is_attachment() ) :
					...
					previous_post_link( '<div class="meta-nav col-md-6">%link</div>', __( '<h5 class="previous">Previous Post</h5><h4>%title</h4>', 'unyson' ) );
					next_post_link( '<div class="meta-nav text-right col-md-6">%link</div>', __( '<h5 class="next">Next Post</h5><h4>%title</h4>', 'unyson' ) );
				endif;
				?>
			</div>
			<!-- .nav-links -->
...
add_action('lastimosa_after_entry','fw_theme_post_nav');
