...
{
    wp_dequeue_style( 'lastimosa-child-theme-style-css' );
}
...
{
    if ( is_child_theme() ) :
        wp_enqueue_style( 'lastimosa-child-theme-style-css', get_stylesheet_uri(), true, filemtime( get_stylesheet_directory() . '/style.css' ), 'all' );
    endif;
}